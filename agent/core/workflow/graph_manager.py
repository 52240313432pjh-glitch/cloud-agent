...
class AgentGraphManager:
    ...
    def __init__(self, mcp_manager=None):
        ...
        self.billing_node = BillingAgentNode(mcp_manager=mcp_manager)
        self.promotion_node = PromotionAgentNode(mcp_manager=mcp_manager)
        self.recommendation_node = RecommendationAgent(mcp_manager=mcp_manager)
        self.finops_node = FinOpsAgentNode(mcp_manager=mcp_manager)
